struct nSunsCAP3_RPE <: AbstractProgramme end
typeProgramme = nSunsCAP3_RPE()
nameProgramme = "nSunsCAP3_RPE"
exerProg = Dict()
### Main lifts
BenchT1 = Exercise(
    name = bench["flat"],
...
push!(exerProg, "BenchT1" => (exercise = BenchT1, progression = CAP3_Bench_T1_RPE))
push!(exerProg, "BenchT2" => (exercise = BenchT2, progression = CAP3_Bench_T2_RPE))
...
push!(exerProg, "DeadliftT1" => (exercise = DeadliftT1, progression = CAP3_Deadlift_T1_RPE))
push!(exerProg, "DeadliftT2" => (exercise = DeadliftT2, progression = CAP3_Deadlift_T2_RPE))
...
push!(exerProg, "SquatT1" => (exercise = SquatT1, progression = CAP3_Squat_T1_RPE))
push!(exerProg, "SquatT2" => (exercise = SquatT2, progression = CAP3_Squat_T2_RPE))
...
push!(exerProg, "RowT1" => (exercise = RowT1, progression = CAP3_Row_T1_RPE))
push!(exerProg, "RowT2" => (exercise = RowT2, progression = CAP3_Row_T2_RPE))
...
function makeDays(::nSunsCAP3_RPE, dict::Dict)
    week1 = [[], [], [], [], [], [], []]
    week2 = [[], [], [], [], [], [], []]
    week3 = [[], [], [], [], [], [], []]
...
days = makeDays(nSunsCAP3_RPE(), exerProg)
push!(
    Lifting_Programmes,
